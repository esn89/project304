...
// ------------------------------------In STORE REFUND: Check Receipt------------------------------------------------   
    ...
    public void inStoreRefund(int iupc, int iquantity) throws SQLException, IOException, ParseException {
...
//			report.append("   " + rs.getString("item_upc") + "         ");
//			report.append("       " + rs.getString("item_category") + "        ");
			prevCat = rs.getString("item_category");
//			report.append("       " + rs.getString("item_price") + "        ");
			units += rs.getInt("purchaseitem_quantity");
//			report.append("       " + rs.getString("purchaseItem_quantity") + "        ");
			value += rs.getDouble("value");
//			report.append("       " + rs.getString("value") + "        ");
			report.append("\n");
